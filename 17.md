...
This document defines that LNURLs will have the format of conventional URLs, with the prefixes `lnurlc:`, `lnurlw:`, `lnurla:` and `lnurlp:` replacing `https://` (for clearnet URLs) and `http://` (for onion URLs). For example:
