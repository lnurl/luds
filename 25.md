...
The four subsections below (Encoding, Seed & derivation, Wallet-side ownership proofs, Mint certificates) are easiest to read once seen as one continuous path, from a `WALLET`'s seed down to a third party verifying a note it was just handed:
